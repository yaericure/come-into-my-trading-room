    ...
    <div className="flex min-w-0 flex-1">
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-8 lg:px-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 h-1.5 w-36 rounded-full bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-200 dark:from-yellow-400 dark:via-yellow-500 dark:to-yellow-900" />
        </div>
        ...
        <footer className="mt-10 pb-4 text-xs leading-relaxed text-zinc-400">
          本站為《走进我的交易室》(亞歷山大・埃爾德 Alexander Elder 著,機械工業出版社)的教學導讀筆記,內容為重點整理與延伸解說,並非原書全文。完整內容請支持正版書籍。
        </footer>
      </main>
